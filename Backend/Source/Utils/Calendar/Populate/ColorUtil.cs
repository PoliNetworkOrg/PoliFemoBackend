...
public static class ColorUtil
{
    internal static void AddBelongsToBasedOnColor2(string color2, DateTime d)
    {
        ...
        switch (color2)
        {
            ...
            {
                query =
                    "INSERT IGNORE INTO belongsTo VALUES ('" + d.ToString("yyyy-MM-dd") + "' , 1);";
            ...
            {
                query =
                    "INSERT IGNORE INTO belongsTo VALUES ('" + d.ToString("yyyy-MM-dd") + "' , 3);";
                PoliNetwork.Db.Utils.Database.Execute(query, GlobalVariables.DbConfigVar);
                break;
            }
            ...
            {
                query =
                    "INSERT IGNORE INTO belongsTo VALUES ('" + d.ToString("yyyy-MM-dd") + "' , 4);";
                PoliNetwork.Db.Utils.Database.Execute(query, GlobalVariables.DbConfigVar);
                break;
            }
            case null: //lezione
            {
                query =
                    "INSERT IGNORE INTO belongsTo VALUES ('" + d.ToString("yyyy-MM-dd") + "' , 5);";
                PoliNetwork.Db.Utils.Database.Execute(query, GlobalVariables.DbConfigVar);
                break;
            }
            ...
            {
                query =
                    "INSERT IGNORE INTO belongsTo VALUES ('" + d.ToString("yyyy-MM-dd") + "' , 6);";
                PoliNetwork.Db.Utils.Database.Execute(query, GlobalVariables.DbConfigVar);
                break;
            }
            ...
            {
                query =
                    "INSERT IGNORE INTO belongsTo VALUES ('" + d.ToString("yyyy-MM-dd") + "' , 7);";
                PoliNetwork.Db.Utils.Database.Execute(query, GlobalVariables.DbConfigVar);
                break;
            }
            ...
            {
                query =
                    "INSERT IGNORE INTO belongsTo VALUES ('" + d.ToString("yyyy-MM-dd") + "' , 8);";
                PoliNetwork.Db.Utils.Database.Execute(query, GlobalVariables.DbConfigVar);
                break;
            }
            ...
            {
                query =
                    "INSERT IGNORE INTO belongsTo VALUES ('" + d.ToString("yyyy-MM-dd") + "' , 9);";
                PoliNetwork.Db.Utils.Database.Execute(query, GlobalVariables.DbConfigVar);
                break;
            }
