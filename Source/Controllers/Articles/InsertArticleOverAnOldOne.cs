...
public class InsertArticleOverAnOldOne :ControllerBase
{
    ...
    public ObjectResult InsertArticleOverAnOldOneDb(int idOld, string? title, string? content) //todo: auth + all parameters
    {
        ...
        var result1 = Source.Utils.Database.ExecuteSelect(q1, GlobalVariables.DbConfigVar, paramsDict1);
        ...
        var result2 = Source.Utils.Database.ExecuteSelect(q2, GlobalVariables.DbConfigVar, paramsDict2);
