...
public static class PoliMiNewsUtil
{
    ...
    {
        var slider =
            NodeUtil.GetElementsByTagAndClassName(HtmlNodeExtended.From(docPoliMi?.DocumentNode),
    ...
    private static void TrySetContent1(NewsPolimi? result, HtmlNodeCollection urls1)
    {
        ...
        try
        {
            ...
            var elementsByTagAndClassName =
                NodeUtil.GetElementsByTagAndClassName(HtmlNodeExtended.From(urls), new List<string> { "p", "ul" });
